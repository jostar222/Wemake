    ...
    <div className="space-y-20">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <p className="text-xl font-light text-foreground">
            The most popular proudcts on wemake by day.
          </p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <p className="text-xl font-light text-foreground">
            The most popular proudcts on wemake by week.
          </p>
        </div>
          {Array.from({length: 7}).map((_, index) => ( 
            <ProductCard
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <p className="text-xl font-light text-foreground">
            The most popular proudcts on wemake by month.
          </p>
        </div>
          {Array.from({length: 7}).map((_, index) => ( 
            <ProductCard
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          <p className="text-xl font-light text-foreground">
            The most popular proudcts on wemake by year.
          </p>
        </div>
          {Array.from({length: 7}).map((_, index) => ( 
            <ProductCard
